    ...
    private void fillPojo(Table table, String[] columns, String[] fields, String[] types) {
        ...
        for (int i = 0; i < table.getColumns().size(); i++) {
            ...
            if ("DATETIME".equalsIgnoreCase(c.getType())
                    && (StringUtils.containsIgnoreCase(c.getField(), "_create") || StringUtils.containsIgnoreCase(c.getField(), "gmt_create"))) {
                c.setCm_(true);
            ...
            if ("TIMESTAMP".equalsIgnoreCase(c.getType())
                    && (StringUtils.containsIgnoreCase(c.getField(), "_modify") || StringUtils.containsIgnoreCase(c.getField(), "gmt_modified"))) {
                c.setCm_(true);
